        ...
        <div ref={featureRef} className={styles.card}>
          <div className={styles.featureInfo}>
            <div className={styles.titleContainer}>
              <EditableField value={editedFeature.title} onSave={(value) => handleFieldChange('title', value, editedFeature, setEditedFeature)} />
            </div>
          ...
          {isModalOpen && (
            <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
              <div className={styles.taskGrid}>
                <motion.div whileHover={{scale: 1.1}} className={styles.createTaskCard} onClick={() => setShowCreateTask(true)}>
                  + Create Task
                </motion.div>
              ...
              {showCreateTask && <CreateComponent type='task' parentId={feature.feature_id} onCancel={() => setIsModalOpen(false)} />}
            </Modal>
          )}
        </div>
      )}
