        ...
        <>
          <div ref={taskDetailRef} className={styles.taskDetail}>
            <div className={styles.topSection}>
              <EditableField value={editedTask.title} onSave={(value) => handleFieldChange('title', value)} />
            ...
            <div className={styles.bottomSection}>
              <EditableField value={editedTask.description} onSave={(value) => handleFieldChange('description', value)} type='textArea' />
            </div>
